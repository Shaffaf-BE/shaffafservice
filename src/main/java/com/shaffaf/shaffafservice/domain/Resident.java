...
public class Resident implements Serializable {
    ...
    public Resident createdBy(String createdBy) {
    ...
    public Resident createdDate(Instant createdDate) {
    ...
    public Resident lastModifiedBy(String lastModifiedBy) {
    ...
    public Resident lastModifiedDate(Instant lastModifiedDate) {
    ...
    public Resident deletedOn(Instant deletedOn) {
    ...
    public Resident unit(Unit unit) {
        this.setUnit(unit);
        return this;
    }
    ...
    public Resident residentType(ResidentType residentType) {
