...
public class UnionMember implements Serializable {
    ...
    public UnionMember firstName(String firstName) {
    ...
    public UnionMember lastName(String lastName) {
    ...
    public UnionMember email(String email) {
        this.setEmail(email);
        return this;
    }
    ...
    public UnionMember phoneNumber(String phoneNumber) {
    ...
    public UnionMember createdBy(String createdBy) {
    ...
    public UnionMember createdDate(Instant createdDate) {
    ...
    public UnionMember lastModifiedBy(String lastModifiedBy) {
    ...
    public UnionMember lastModifiedDate(Instant lastModifiedDate) {
    ...
    public UnionMember deletedOn(Instant deletedOn) {
    ...
    public UnionMember project(Project project) {
