...
/**
 * A DTO for the {@link com.shaffaf.shaffafservice.domain.UnionMember} entity.
 */
...
public class UnionMemberDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnionMemberDTO)) {
            return false;
        }

        UnionMemberDTO unionMemberDTO = (UnionMemberDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, unionMemberDTO.id);
    }
