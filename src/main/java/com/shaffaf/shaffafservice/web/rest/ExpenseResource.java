...
/**
 * REST controller for managing {@link com.shaffaf.shaffafservice.domain.Expense}.
 */
@RestController
...
public class ExpenseResource {
    ...
    private static final String ENTITY_NAME = "shaffafserviceExpense";
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<ExpenseDTO>> getAllExpenses(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
